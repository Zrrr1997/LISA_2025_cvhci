...
def parse_args():
    ...
    parser.add_argument(
        "--dataset", default="TriALS", choices=["TriALS", "LISA"]
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--network",
        default="dynunet",
        choices=["dynunet", "smalldynunet", "bigdynunet", "bigdynunet2", "matteodynunet", 'segresnet'],
    )
    parser.add_argument(
        "-in",
        "--inferer",
...
def setup_environment_and_adapt_args(args, docker=False):
    ...
    if args.target == 'hippocampus' or 'hipp' in args.resume_from:
        args.labels = {'left_hippocampus': 1, 'right_hippocampus': 2, "background": 0}
    elif args.target == 'all_structures' or args.target == 'validation':
        args.labels = {'left_hippocampus': 1, 'right_hippocampus': 2, 'left_ventricle': 3, 'right_ventricle': 4, 'left_caudate': 5, 'right_caudate': 6, 'left_lentiform': 7, 'right_lentiform': 8, "background": 0}
